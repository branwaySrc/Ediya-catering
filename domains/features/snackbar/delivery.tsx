	...
	return (
		<section id="care" className="scroll-mt-24 bg-[#F3F6FB] py-20 sm:py-28" aria-labelledby="delivery-heading">
			<ScreenSection>
				...
				<div className="mt-10 grid overflow-hidden rounded-lg border border-slate-200 bg-white md:grid-cols-3">
