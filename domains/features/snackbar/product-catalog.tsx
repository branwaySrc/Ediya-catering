...
export function ProductCatalog() {
	...
	return (
		<section id="products" className="scroll-mt-24 bg-[#F8F9FC] py-20 sm:py-28" aria-labelledby="product-catalog-heading">
			<ScreenSection>
				<header className="mx-auto max-w-3xl text-center">
					...
					<h2 id="product-catalog-heading" className="mt-4 text-3xl font-bold tracking-[-0.03em] text-slate-900 sm:text-4xl">어떤 제품을 채울지 살펴보세요</h2>
						...
						<article key={product.id} className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm">
							...
							<div className="border-t border-slate-100 p-6">
								<div className="flex items-start justify-between gap-4">
									...
									<span className="shrink-0 rounded-full bg-blue-50 px-2.5 py-1 text-[11px] font-bold text-[#1C5DBE]">{product.storage}</span>
								</div>
