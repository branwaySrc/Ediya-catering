						...
						<div className="border-t border-white/10 bg-white/[0.06] p-7 sm:p-10 lg:border-l lg:border-t-0 lg:p-14">
							<div className="space-y-6">
								<div className="flex gap-4">
									...
									<div><h3 className="font-bold">머신 수량 맞춤</h3><p className="mt-2 text-sm leading-6 text-blue-100/70">설치 공간과 예상 이용량에 맞춰 필요한 머신 수량을 상담합니다.</p></div>
								</div>
								<div className="flex gap-4">
									<FileText className="mt-0.5 size-5 shrink-0 text-[#FBB34B]" aria-hidden="true" />
									<div><h3 className="font-bold">캡슐 납품 약정</h3><p className="mt-2 text-sm leading-6 text-blue-100/70">최소 납품량과 계약 기간은 머신 수량과 예상 소비량을 기준으로 협의합니다.</p></div>
								</div>
							</div>
							<p className="mt-8 rounded-md border border-white/10 bg-black/10 p-4 text-xs leading-6 text-blue-100/65">계약 전 머신 제공 조건, 최소 캡슐 납품량, 계약 기간을 견적서에 명확하게 안내합니다.</p>
						</div>
					</div>
				</div>
			</ScreenSection>
