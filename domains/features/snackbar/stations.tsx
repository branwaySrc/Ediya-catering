		...
		<section id="stations" className="scroll-mt-24 bg-white py-20 sm:py-28">
			<ScreenSection>
				<header className="mx-auto max-w-3xl text-center">
					...
					<h2 className="mt-4 text-3xl font-bold tracking-[-0.03em] text-slate-900 sm:text-4xl">필요한 방식으로 골라 구성하세요</h2>
						...
						return (
							<article key={station.id} className="group overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
								...
								<div className="p-6 sm:p-7">
									<p className="text-xs font-bold uppercase tracking-[0.16em] text-slate-400">{station.nameEn}</p>
									<h3 className="mt-2 text-2xl font-bold text-slate-900">{station.name}</h3>
