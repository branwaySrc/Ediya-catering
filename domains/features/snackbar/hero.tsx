			...
			<ScreenSection className="flex min-h-[42rem] items-center py-20 sm:min-h-[48rem] sm:py-28">
				<div className="max-w-3xl">
					<TitleBadge className="pb-5">
						...
						<TitleBadge.Title className="text-white">EDIYA OFFICE SNACK</TitleBadge.Title>
						<TitleBadge.Badge backgroundColor="" className="border-white/30 bg-white/10 text-white">
							SNACK
						</TitleBadge.Badge>
					</TitleBadge>
					...
					<div className="mt-9 flex flex-col gap-3">
						<Button.Link
							...
							icon={ArrowRight}
							iconPosition="right"
							className="h-12 bg-white px-6 text-[#172966] hover:bg-blue-50"
						>
							맞춤 구성 상담
						</Button.Link>
