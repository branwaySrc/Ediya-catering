...
export function CateringProcess() {
	return (
		<section className="bg-[#F8F9FC] py-20 sm:py-24" aria-labelledby="catering-process-heading">
			<ScreenSection>
				<div className="mx-auto max-w-3xl text-center">
					...
					<p className="hidden text-sm font-bold uppercase tracking-[0.16em] text-primary/55">Process</p>
					<h2 id="catering-process-heading" className="mt-4 text-3xl font-bold text-primary sm:text-4xl">
					...
					{cateringProcessSteps.map((step, index) => (
						<li key={step} className="relative rounded-lg border border-primary/10 bg-white p-5 shadow-sm">
							<div className="flex items-center justify-between gap-3">
								<span className="text-xs font-bold uppercase tracking-[0.14em] text-primary/45">Step {String(index + 1).padStart(2, "0")}</span>
