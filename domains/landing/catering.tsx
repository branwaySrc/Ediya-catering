...
function CateringHero() {
	return (
		<div className="relative mb-4 h-120 overflow-hidden sm:h-180">
	...
	return (
		<div className={`relative ml-4 flex min-w-70 shrink-0 snap-start flex-col md:ml-0 md:min-w-0 md:shrink ${className ?? ""}`}>
			<div className="w-full max-w-70 lg:max-w-none">
				<CardSection className="relative h-70 w-full shrink-0 overflow-hidden rounded-none border-none bg-slate-100">
